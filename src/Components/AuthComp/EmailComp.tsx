    ...
    <section className='w-[25%] mt-[3%] mx-[auto] max-h-screen'>
      <div>
        ...
        <form onSubmit={handlesubmit} className='flex flex-col'>
          <label className='font-[500] text-sm mb-[1%]' htmlFor="email">Email  address</label>
          <input required autoComplete='off' className='outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 mb-[5%] text-[14px] px-[2%] py-[1%] font-[50] border-[1px] rounded border-black' type="email" id='email' name='email' placeholder='Enter your email address' />
          <button className='bg-blue-600 text-white rounded py-[2%]'>Continue with email</button>
        </form>
      </div>
